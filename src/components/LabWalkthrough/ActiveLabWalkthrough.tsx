import { ShieldCheck, AlertCircle, HelpCircle, Terminal, ChevronRight, CheckCircle } from "lucide-react";
import { motion, AnimatePresence } from "motion/react";
import { Lab } from "../../data/labs";

interface ActiveLabWalkthroughProps {
  activeLab: Lab | undefined;
  ...
  onClearSelectedLab: () => void;
  onToggleStuckMode: () => void;
  onTechnicianIssueChange: (issue: string) => void;
  onDiagnose: () => void;
  onStepComplete: () => void;
}

export default function ActiveLabWalkthrough({
  activeLab,
  activeStepIdx,
  completedSteps,
  isStuckMode,
  ...
  onClearSelectedLab,
  onToggleStuckMode,
  onTechnicianIssueChange,
  onDiagnose,
  onStepComplete,
}: ActiveLabWalkthroughProps) {
  if (!activeLab) {
    return (
                  ...
                  <div className="p-4 bg-watchguard-lightgray rounded-xl border border-watchguard-border space-y-3">
                    ...
                    <div className="flex items-center space-x-3">
                      <input
                        ...
                        onChange={(e) => onTechnicianIssueChange(e.target.value)}
