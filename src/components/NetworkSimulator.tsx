...
export default function NetworkSimulator() {
  ...
  return <div className="sandbox-workspace">
    <header className="section-heading"><div><p className="eyebrow">PACKET PATH LAB</p><h1>Follow the flow. Find the cause.</h1><p>Change a policy, send a test flow, and see exactly which decision changes.</p></div><span className="catalog-count"><FlaskConical size={18}/>{challenges.length} guided challenges</span></header>
