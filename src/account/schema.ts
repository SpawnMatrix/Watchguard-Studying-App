...
export const STUDY_KEYS = ['watchguard-study-progress-v1','weakness_deck','watchguard_mastered_flashcards','watchguard-quiz-session-v2','watchguard-study-profile-name-v1'] as const;
