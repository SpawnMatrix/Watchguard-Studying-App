...
export const examQuestions: Question[] = [
  ...
  },
  {
    id: 2,
    question:
      "What is the purpose of the WatchGuard Authentication policy? (Select one.)",
    options: [
  ...
  },
  {
    id: 3,
    question:
      "From the policies shown in the default configuration, can users in the Sales group connect from the trusted network to websites with HTTPS if only the default Outgoing policy is enabled? (Select one.)",
    options: [
  ...
  },
  {
    id: 4,
    question:
      "You can configure Dynamic NAT to route incoming connections from the Internet to two different FTP servers on the trusted network. (Select one.)",
    options: ["True", "False"],
    correctAnswer: "False",
  ...
  },
  {
    id: 5,
    question:
      "What port and protocol is used by default for DNS query resolution? (Select one.)",
  ...
  },
  {
    id: 6,
    question:
      "What is the purpose of a Static NAT (SNAT) policy mapping public IP 203.0.113.80 to private IP 10.0.20.80 on port 80? (Select one.)",
    options: [
  ...
  },
  {
    id: 7,
    question:
      "While troubleshooting a branch office VPN tunnel, you see the log message: 'iked peer proposes phase two negotiation failed: Received proposal without PFS, Expecting PFS enabled'. Which setting should you modify? (Select one.)",
    options: [
  ...
  },
  {
    id: 8,
    question:
      "You want to route traffic from clients on the 192.168.10.0/24 subnet to a server at 10.0.20.80 behind a router with IP 192.168.10.5. Which static routes could you add? (Select TWO.)",
    options: [
    ...
    correctAnswer:
      "Route to 10.0.20.0/24, Gateway 192.168.10.5 | Route to 10.0.20.80, Gateway 192.168.10.5",
    correctAnswers: [
      "Route to 10.0.20.80, Gateway 192.168.10.5",
      "Route to 10.0.20.0/24, Gateway 192.168.10.5",
    ],
  ...
  },
  {
    id: 9,
    question:
      "You can use the TCP-UDP proxy to control Web, FTP, and SIP traffic on ports other than standard 80, 21, and 5060. (Select one.)",
    options: ["True", "False"],
    correctAnswer: "True",
    correctAnswers: ["True"],
    isMultiSelect: false,
  ...
  },
  {
    id: 11,
    question:
      "When your device is in a default state, to which interface do you connect your management computer so you can use the Quick Setup Wizard? (Select one.)",
    options: [
  ...
  },
  {
    id: 13,
    question:
      "To use the Web Setup Wizard or Quick Setup Wizard to configure your Firebox, your computer must have an IP address on which subnet? (Select one.)",
    options: [
      "10.0.10.0/24",
      "10.0.1.0/24",
      "172.16.10.0/24",
  ...
  },
  {
    id: 14,
    question:
      "Which items are included in a Firebox backup image file (.fxi)? (Select FOUR.)",
    options: [
      "Configuration file",
      "Fireware OS image",
      "Log files",
    ...
    correctAnswer:
      "Configuration file | Certificates | Passwords | Feature keys",
    correctAnswers: [
      "Configuration file",
      "Certificates",
      "Passwords",
  ...
  },
  {
    id: 15,
    question:
      "The policies in a default Firebox configuration do not allow outgoing traffic from optional interfaces. (Select one.)",
    options: ["True", "False"],
    correctAnswer: "False",
    correctAnswers: ["False"],
    isMultiSelect: false,
  ...
  },
  {
    id: 16,
    question:
      "When you examine log messages in Traffic Monitor, you see network packets are denied with an 'Unhandled Internal Packet' message. What does this log message mean? (Select one.)",
    options: [
  ...
  },
  {
    ...
    correctAnswer:
      "Enable the AUTO-block sites that attempt to connect option in a deny policy. | On the Firebox System Manager > Blocked Sites tab, select Add. | In Policy Manager, select Setup > Default Threat Protection > Blocked Sites and click Add.",
    correctAnswers: [
      "Enable the AUTO-block sites that attempt to connect option in a deny policy.",
      "On the Firebox System Manager > Blocked Sites tab, select Add.",
      "In Policy Manager, select Setup > Default Threat Protection > Blocked Sites and click Add.",
  ...
  },
  {
    ...
    correctAnswer:
      "Denial of service attacks | Flood attacks | Port scans | IP spoofing",
    correctAnswers: [
      "Denial of service attacks",
      "Flood attacks",
      "Port scans",
  ...
  },
  {
    id: 19,
    question:
      "If you disable the default Outgoing policy, which policies must you add to allow trusted users to connect to commonly used websites? (Select THREE.)",
    options: [
      "HTTP port 80",
      "NAT policy",
      "FTP port 21",
  ...
  },
  {
    ...
    correctAnswer:
      "Only a proxy policy can prevent specific threats without blocking the entire connection. | Only a proxy works at the application, network, and transport layers to examine all connection data.",
    correctAnswers: [
      "Only a proxy policy can prevent specific threats without blocking the entire connection.",
      "Only a proxy works at the application, network, and transport layers to examine all connection data.",
    ],
  ...
  },
  {
    id: 22,
    question:
      "You need to create an HTTP-proxy policy to a specific domain for software updates (example.com). The update site has multiple subdomains and dynamic IP addresses on a CDN. Which of these is the best way to define the destination? (Select one.)",
    options: [
  ...
  },
  {
    id: 23,
    question:
      "Which takes precedence: a WebBlocker category match or a WebBlocker exception? (Select one.)",
  ...
  },
  {
    id: 25,
    question:
      "Which ports and protocols must be allowed through external network firewalls to support Mobile VPN with IKEv2? (Select one.)",
    options: [
  ...
  },
  {
    id: 26,
    question:
      "To block downloads of .exe executable files on trusted networks, which HTTP proxy action category must you configure? (Select one.)",
    options: [
  ...
  },
  {
    id: 27,
    question:
      "A Branch Office VPN (BOVPN) negotiation fails in Phase 1. What are the most likely causes of this negotiation error? (Select TWO.)",
    options: [
    ...
    correctAnswer:
      "Mismatched pre-shared keys | Mismatched Phase 1 proposal encryption algorithms",
    correctAnswers: [
      "Mismatched pre-shared keys",
      "Mismatched Phase 1 proposal encryption algorithms",
    ],
  ...
  },
  {
    id: 28,
    question:
      "When configuring Multi-WAN on a Firebox, which routing method routes traffic based on interface bandwidth utilization thresholds? (Select one.)",
    options: [
      "Spillover",
      "Round-Robin",
      "Interface Failover",
  ...
  },
  {
    id: 29,
    question:
      "Which verification protocol does a Firebox Link Monitor use by default to test link viability? (Select one.)",
    options: [
  ...
  },
  {
    id: 30,
    question:
      "What is the default behavior of the Firebox HTTPS Proxy when it encounters an expired SSL certificate on an external server during HTTPS inspection? (Select one.)",
    options: [
  ...
  },
  {
    id: 31,
    question:
      "If a Firebox cannot connect to the cloud-hosted WebBlocker servers, what is the default response configuration? (Select one.)",
    options: [
  ...
  },
  {
    id: 32,
    question:
      "What is the default virtual IP address pool subnet configured automatically for Mobile VPN with SSL clients? (Select one.)",
    options: [
      "192.168.113.0/24",
      "10.0.1.0/24",
      "10.0.113.0/24",
  ...
  },
  {
    id: 33,
    question:
      "Which WatchGuard management application allows you to edit and save a configuration file offline before applying it to a live Firebox? (Select one.)",
    options: [
      "Policy Manager",
      "Fireware Web UI",
  ...
  },
  {
    id: 34,
    question:
      "The Intrusion Prevention Service (IPS) operates by scanning network packets for matching signatures of known security vulnerabilities. (Select one.)",
    options: ["True", "False"],
    correctAnswer: "True",
    correctAnswers: ["True"],
    isMultiSelect: false,
  ...
  },
  {
    id: 35,
    question:
      "Which of these subscription security services require Gateway AntiVirus signature scanner to be configured and active? (Select TWO.)",
    options: [
      "APT Blocker",
      "WebBlocker",
  ...
  },
  {
    id: 36,
    question:
      "When configuring a Branch Office VPN (BOVPN) failover, what mechanism does the Firebox use to dynamically switch gateways on ISP link failure? (Select one.)",
    options: [
  ...
  },
  {
    id: 37,
    question:
      "Which standalone application in WatchGuard System Manager is used specifically to view real-time log messages and active traffic flows? (Select one.)",
    options: [
  ...
  },
  {
    id: 38,
    question:
      "If you configure a 1-to-1 NAT mapping on your External interface, does this configuration automatically create policies to allow inbound connections? (Select one.)",
    options: [
  ...
  },
  {
    id: 39,
    question:
      "To authenticate users against their Active Directory domain controller credentials, what information must be configured in the AD auth settings? (Select one.)",
    options: [
  ...
  },
  {
    id: 40,
    question:
      "On all multi-port locally-managed Fireboxes, what physical port interface ID maps to the default Trusted interface zone on startup? (Select one.)",
    options: [
      "Interface 1 (Eth1)",
      "Interface 0 (Eth0)",
      "Interface 2 (Eth2)",
  ...
  },
  {
    id: 41,
    question:
      "Which NAT type is bidirectional, mapping a single private IP address to a dedicated public IP address for both inbound and outbound traffic? (Select one.)",
    options: [
      "Dynamic NAT",
      "1-to-1 NAT",
      "Static NAT (SNAT)",
  ...
  },
  {
    id: 42,
    question:
      "What happens to a packet when multiple Multi-WAN interfaces are configured and one interface fails its Link Monitor check? (Select one.)",
    options: [
  ...
  },
  {
    id: 43,
    question:
      "You want to allow users to view a blocked website category, but require them to acknowledge a warning page before proceeding. Which WebBlocker action should you configure? (Select one.)",
  ...
  },
  {
    id: 44,
    question:
      "Which Firebox cluster configuration requires active-active load balancing switches to be deployed upstream and downstream of the cluster? (Select one.)",
    options: [
      "Active/Passive Cluster",
      "Active/Active Cluster",
      "Dynamic Routing Multi-Cluster",
      "Drop-In Clustering",
    ],
  ...
  },
  {
    id: 45,
    question:
      "What is the primary security goal of WatchGuard DNSWatch? (Select one.)",
    options: [
  ...
  },
  {
    id: 46,
    question:
      "When configuring Mobile VPN with SSL, which of these is the default protocol and port used for VPN tunnels? (Select one.)",
  ...
  },
  {
    id: 47,
    question:
      "In a branch office VPN configuration, which of these is a Phase 1 proposal setting that must match on both Fireboxes? (Select one.)",
    options: [
  ...
  },
  {
    id: 48,
    question:
      "Which tool inside WatchGuard System Manager (WSM) allows you to run diagnostic checks like Ping, DNS lookup, TCP Dump, or Traceroute? (Select one.)",
    options: [
      "Policy Manager",
      "Firebox System Manager",
      "Log Server",
  ...
  },
  {
    id: 49,
    question:
      "Which default WatchGuard Policy allows all traffic originating from a trusted or optional interface to connect to any external network? (Select one.)",
    options: [
      "WatchGuard Policy",
      "Any-Trusted Policy",
      "Outgoing Policy",
  ...
  },
  {
    id: 50,
    question:
      "To inspect outbound encrypted HTTPS traffic, which certificate must be installed in the Trusted Root Certification Authorities store of all client computers? (Select one.)",
    options: [
  ...
  },
  {
    id: 52,
    question:
      "Which Multi-WAN routing method distributes outbound traffic proportionally among active interfaces based on user-defined weights? (Select one.)",
    options: [
      "Round-Robin",
      "Spillover",
      "Interface Failover",
  ...
  },
  {
    id: 53,
    question:
      "When multiple policies are configured in Policy Manager, how does the Firebox determine the order of policy precedence? (Select one.)",
    options: [
  ...
  },
  {
    id: 54,
    question:
      "Which of these proxies can be used to scan inbound and outbound email messages for virus signatures or spam content? (Select TWO.)",
  ...
  },
  {
    id: 55,
    question:
      "Which WatchGuard security subscription service scans files using cloud-based sandboxing to identify zero-day malware? (Select one.)",
    options: [
      "Gateway AntiVirus",
      "IntelligentAV",
      "APT Blocker",
  ...
  },
  {
    id: 56,
    question:
      "You are configuring Mobile VPN with IKEv2. Which client authentication databases are supported? (Select THREE.)",
    options: [
      "Firebox-DB",
      "RADIUS",
  ...
  },
  {
    id: 57,
    question:
      "What is the default IKE protocol version used for high-reliability, zero-touch VPN gateway configurations on modern Fireboxes? (Select one.)",
  ...
  },
  {
    id: 58,
    question:
      "You are searching for denied traffic from a specific client IP address in real-time. Which application in WatchGuard System Manager should you open? (Select one.)",
    options: [
      "FSM > Log Server",
      "FSM > Traffic Monitor",
      "FSM > Status Report",
  ...
  },
  {
    id: 59,
    question:
      "You need to restore a configuration onto a brand new replacement Firebox of a different model. Can you use a Backup Image (.fxi) file? (Select one.)",
    options: [
  ...
  },
  {
    id: 60,
    question:
      "Which configuration allows internal users to connect to a local mail server on the Trusted zone using its public IP address? (Select one.)",
    options: [
      "1-to-1 NAT",
      "Dynamic NAT Pool",
      "NAT Loopback",
  ...
  },
  {
    id: 61,
    question:
      "What happens if you configure an HTTPS Proxy to allow connections with unrecognized SSL/TLS certificate authority signatures? (Select one.)",
    options: [
  ...
  },
  {
    id: 62,
    question:
      "What occurs when you assign an interface to the 'Optional' zone during setup? (Select one.)",
    options: [
  ...
  },
  {
    id: 63,
    question:
      "Which subscription service assigns a reputational score to outbound connection destinations to optimize scanning latency? (Select one.)",
    options: [
      "DNSWatch",
  ...
  },
  {
    id: 64,
    question:
      "If a Mobile VPN with SSL client cannot browse resources on the Trusted network, what is the most likely cause? (Select TWO.)",
    options: [
    ...
    correctAnswer:
      "The virtual IP address pool overlaps with the client's local network subnet. | The SSL-VPN policy does not allow traffic from the SSL-VPN group to Any-Trusted.",
    correctAnswers: [
      "The virtual IP address pool overlaps with the client's local network subnet.",
      "The SSL-VPN policy does not allow traffic from the SSL-VPN group to Any-Trusted.",
    ],
  ...
  },
  {
    id: 65,
    question:
      "What is the purpose of enabling 'Perfect Forward Secrecy' (PFS) in your BOVPN Tunnel configuration? (Select one.)",
    options: [
  ...
  },
  {
    id: 66,
    question:
      "Where in the Fireware Web UI can you check the active routing table of your Firebox? (Select one.)",
    options: [
      "Dashboard > Front Panel",
      "System Status > Routes",
      "Firewall > Policies",
      "Subscription Services > Diagnostics",
    ],
  ...
  },
  {
    id: 67,
    question:
      "To manage a Firebox that is in its factory-default state, you can connect your computer to Interface 1 and open a web browser to which URL? (Select one.)",
    options: [
      "http://10.0.1.1:4126",
      "https://10.0.1.1:8080",
      "https://10.0.1.1:4135",
  ...
  },
  {
    id: 68,
    question:
      "You want to allow the marketing group to use FTP, but block all other departments. Which policy configuration accomplishes this? (Select one.)",
    options: [
  ...
  },
  {
    id: 69,
    question:
      "You have a single public IP address on your External interface (203.0.113.80). You want to host a web server (port 80) and a mail server (port 25) on different private internal IPs. Which NAT method should you use? (Select one.)",
    options: [
      "1-to-1 NAT",
      "Dynamic NAT",
      "Static NAT (SNAT)",
  ...
  },
  {
    id: 70,
    question:
      "What is the default subnet of Interface 1 (Trusted) on a factory-default Firebox? (Select one.)",
  ...
  },
  {
    id: 71,
    question:
      "In the HTTP Proxy, under which setting can you block files with specific extensions (like .zip or .rar) from being downloaded? (Select one.)",
    options: [
      "HTTP Request > Request Methods",
      "HTTP Response > Body Content Types",
      "HTTP Response > Header Fields",
      "WebBlocker Exception Rules",
    ],
    correctAnswer: "HTTP Response > Body Content Types",
    correctAnswers: ["HTTP Response > Body Content Types"],
    isMultiSelect: false,
  ...
  },
  {
    id: 72,
    question:
      "Which WatchGuard security subscription uses machine learning to identify malware signatures without traditional daily definition updates? (Select one.)",
  ...
  },
  {
    id: 73,
    question:
      "Which Mobile VPN type is native to major modern operating systems (Windows, macOS, iOS) and does not require third-party software installation? (Select one.)",
    options: [
      "Mobile VPN with SSL",
      "Mobile VPN with IKEv2",
      "Mobile VPN with OpenVPN",
      "Mobile VPN with IPSec (Legacy)",
    ],
  ...
  },
  {
    id: 74,
    question:
      "While reviewing logs, you see 'proposes phase two negotiation failed: Mismatched SA life'. How do you resolve this BOVPN issue? (Select one.)",
    options: [
  ...
  },
  {
    id: 75,
    question:
      "Which service in a WatchGuard Dimension deployment stores historical reporting data? (Select one.)",
    options: [
      "Dimension Log Collector",
      "Dimension Server database",
      "Log Agent",
      "Report Engine Daemon",
    ],
  ...
  },
  {
    id: 76,
    question:
      "Which status indicator light on the physical front panel of a Firebox indicates active management or configuration synchronization? (Select one.)",
  ...
  },
  {
    id: 77,
    question:
      "Which policy takes precedence if you have a policy allowing HTTP traffic from 'Any-Trusted' to 'Any-External', and a policy denying HTTP traffic from client '10.0.1.25' to 'Any-External' placed above it? (Select one.)",
    options: [
  ...
  },
  {
    id: 78,
    question:
      "When configuring 1-to-1 NAT, what happens to outbound traffic originating from the mapped private host? (Select one.)",
    options: [
  ...
  },
  {
    id: 79,
    question:
      "What happens to outbound internet traffic if all WAN connections fail in an SD-WAN configuration? (Select one.)",
    options: [
  ...
  },
  {
    id: 80,
    question:
      "Which of these proxies can intercept and control remote administrative sessions using protocols like RDP, SSH, or Telnet? (Select one.)",
  ...
  },
  {
    id: 81,
    question:
      "You want to block access to specific online streaming applications (like YouTube or Netflix) regardless of their URL domain. Which service should you configure? (Select one.)",
  ...
  },
  {
    id: 82,
    question:
      "What virtual IP address pool should you assign to Mobile VPN with SSL clients? (Select one.)",
    options: [
  ...
  },
  {
    id: 83,
    question:
      "In a Policy-Based BOVPN, what controls which traffic is allowed to traverse the VPN tunnel? (Select one.)",
    options: [
  ...
  },
  {
    id: 84,
    question:
      "Which file format is used when you export log files from Firebox System Manager Traffic Monitor for offline analysis? (Select one.)",
  ...
  },
  {
    id: 85,
    question:
      "To activate subscription services (like WebBlocker, GAV, etc.) on your Firebox, what must you import onto the device? (Select one.)",
    options: [
      "A Certificate Revocation List (CRL)",
      "A Feature Key file",
      "A firmware signature patch",
      "A WSM licensing template",
    ],
  ...
  },
  {
    id: 86,
    question:
      "Can a user-defined alias contain FQDNs, IP addresses, and other aliases? (Select one.)",
    options: ["Yes", "No"],
    correctAnswer: "Yes",
    correctAnswers: ["Yes"],
    isMultiSelect: false,
  ...
  },
  {
    id: 87,
    question:
      "You are configuring a Static NAT (SNAT) mapping. What are the valid destinations you can specify in the SNAT action? (Select TWO.)",
    options: [
      "A single private IP address",
      "A domain name alias",
      "A virtual loopback IP address",
      "An IP address range or server pool with load balancing",
    ],
    correctAnswer:
      "A single private IP address | An IP address range or server pool with load balancing",
    correctAnswers: [
      "A single private IP address",
      "An IP address range or server pool with load balancing",
    ],
  ...
  },
  {
    id: 88,
    question:
      "Which WatchGuard feature tests the latency, jitter, and packet loss of an interface link to determine optimal path routing for specific applications? (Select one.)",
    options: [
      "Multi-WAN Spillover",
      "SD-WAN",
  ...
  },
  {
    id: 89,
    question:
      "When configuring WebBlocker exceptions, which of these match types can you use to define exception patterns? (Select THREE.)",
    options: [
      "Exact URL match",
    ...
    correctAnswer:
      "Exact URL match | Pattern match (using wildcards like *) | Regular Expression match",
    correctAnswers: [
      "Exact URL match",
      "Pattern match (using wildcards like *)",
      "Regular Expression match",
  ...
  },
  {
    id: 90,
    question:
      "What is the action options available in Gateway AntiVirus when a virus is detected in a scanned file? (Select THREE.)",
  ...
  },
  {
    id: 91,
    question:
      "Which Mobile VPN client uses an installer containing a configuration file with the extension '.ovpn'? (Select one.)",
    options: [
      "Mobile VPN with SSL",
      "Mobile VPN with IKEv2",
  ...
  },
  {
    id: 92,
    question:
      "What is the difference between a Virtual Interface BOVPN and a Policy-Based BOVPN? (Select one.)",
    options: [
  ...
  },
  {
    id: 93,
    question:
      "You suspect a hardware interface is failing and causing packet drops. Where can you view physical link-state logs (such as 'Link down')? (Select one.)",
    options: [
      "Traffic Monitor",
      "FSM Status Report > Log Message Center",
      "FSM System Status > Interfaces",
      "WSM Dimension Reports",
    ],
  ...
  },
  {
    id: 94,
    question:
      "What is the default IP address of the Trusted interface on startup? (Select one.)",
  ...
  },
  {
    id: 95,
    question:
      "What physical interfaces are automatically added to the default Outgoing policy destination group? (Select one.)",
    options: [
      "Any-Trusted",
      "Any-External",
      "Any-Optional",
      "Any-Trusted and Any-Optional",
    ],
  ...
  },
  {
    id: 97,
    question:
      "What protocol does Link Monitor use to test the connectivity of a gateway when TCP Port Probes are configured? (Select one.)",
    options: [
      "ICMP",
      "TCP Syn handshake",
  ...
  },
  {
    id: 98,
    question:
      "You want to allow remote administrators to connect via SSH to an internal server on port 22, but prevent them from executing specific file-transfer commands over SSH. Can a standard TCP-UDP packet filter accomplish this? (Select one.)",
    options: [
  ...
  },
  {
    id: 99,
    question:
      "Which WatchGuard security subscription service protects users from downloading files containing malware based on metadata reputation checks, before the file is fully downloaded? (Select one.)",
    options: [
      "Gateway AntiVirus",
      "APT Blocker",
      "Reputation Enabled Defense (RED)",
  ...
  },
  {
    id: 100,
    question:
      "In a Firebox high availability Active/Passive configuration, how are configurations synchronized between the master and backup devices? (Select one.)",
    options: [
  ...
  },
  {
    id: 101,
    question:
      "Which of the following is true regarding BOVPN over TLS? (Select one.)",
    options: [
  ...
  },
  {
    id: 102,
    question:
      "If a user complains they cannot reach a specific public website but other sites work, and you see 'Denied' messages in Traffic Monitor related to WebBlocker, what should you do first to resolve this while maintaining security? (Select one.)",
    options: [
  ...
  },
  {
    id: 103,
    question:
      "When configuring a firewall policy, what happens if you select 'Auto-Order' in Policy Manager? (Select one.)",
    options: [
  ...
  },
  {
    id: 104,
    question:
      "Which Firebox feature allows you to monitor and block applications like BitTorrent or Skype? (Select one.)",
    options: [
      "WebBlocker",
      "Application Control",
      "Intrusion Prevention Service (IPS)",
  ...
  },
  {
    id: 105,
    question:
      "In what scenario would you use a Drop-In network configuration? (Select one.)",
    options: [
